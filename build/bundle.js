...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentBox = function (_Component) {
	  ...
	  function CommentBox() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(CommentBox)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      data: []
	    }, _this.handleCommentSubmit = function (comment) {
	      var comments = _this.state.data;
	      comment.id = Date.now();
	      _this.setState({ data: [].concat(_toConsumableArray(comments), [comment]) });
	  ...
	  _createClass(CommentBox, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      (0, _reqwest2.default)({
	        ...
	        success: function success(resp) {
	          _this2.setState({ data: _this2.reduceToList(resp) });
	        },
	    ...
	    key: 'reduceToList',
	    value: function reduceToList(resp) {
	      return resp.items.map(function (item, index) {
	        return {
	          id: index,
	          author: item.volumeInfo.authors.toString(),
	          text: item.volumeInfo.description === undefined ? 'no description' : item.volumeInfo.description
	        };
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(CommentList, { comments: this.state.data }),
	...
	var CommentForm = function (_Component3) {
	  ...
	  function CommentForm() {
	    ...
	    return _ret2 = (_temp2 = (_this4 = _possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(CommentForm)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this4), _this4.state = {
	      author: '',
	      text: ''
	    }, _this4.handleAuthorChange = function (e) {
	      _this4.setState({ author: e.target.value });
	    }, _this4.handleTextChange = function (e) {
	      _this4.setState({ text: e.target.value });
	    }, _this4.handleSubmit = function (e) {
	      e.preventDefault();
	      var author = _this4.state.author.trim();
	      var text = _this4.state.text.trim();
	      if (!text || !author) {
	        return;
	      }
	      _this4.props.onCommentSubmit({ author: author, text: text });
	      _this4.setState({ author: '', text: '' });
	...
	_reactDom2.default.render(_react2.default.createElement(CommentBox, { url: 'https://www.googleapis.com/books/v1/volumes?q=cat+inauthor:kurt+vonnegut' }), document.getElementById('content'));
